...
# MODEL_PATH="/root/code/Qwen2.5-VL-3B-Instruct/" 
MODEL_PATH="/fs-computility/ai4sData/shared/models/Qwen2.5-VL-3B-Instruct"
BSZ=50 # reduce it if GPU OOM
OUTPUT_PATH="/root/code/R1-V/src/eval/output/eval_result_2.json"
