...
# path: transformers/src/transformers/models/qwen2_5_vl/modular_qwen2_5_vl.py
...
def apply_rotary_pos_emb_flashatt(
    ...
    q_embed = apply_rotary_emb(q.to(cos.dtype), cos, sin).to(q.dtype)
    k_embed = apply_rotary_emb(k.to(cos.dtype), cos, sin).to(k.dtype)
